...
void PrintArray(int n, movie_data *array, FILE* path, char* sorted){
    ...
    for(i=0; i < n; i++){
            fprintf(path,  
            "%s, %s, %lf,%lf, %lf, %lf,%s, %lf, %lf,%s, %s, %s,%lf, %lf, %s,%lf, %s, %s,%lf, %s, %s,%s, %lf, %lf,%lf, %lf, %lf,%lf\n", 
